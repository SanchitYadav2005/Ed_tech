      ...
      <>
        ...
        <main className="about-section">
          ...
          <div className="contain-others">
            <div>
              <img src={videos} alt="best videos"  style={{height:'265px'}}/>
              <p>
          ...
          <div className="second-container">
              ...
              <p>
                ...
                inspire intellectual curiosity. Develop critical thinking skills
                and embrace a growth mindset that extends far beyond the
                classroom.
              </p>
            </div>
            </Slide>
